...
final class AllAccountsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    struct Constants {
        static var yourAccounts = R.string.localizable.allAccountsScreenYourAccounts()
        static var delete = R.string.localizable.allAccountsScreenDelete()
        static var cancel = R.string.localizable.allAccountsScreenCancel()

        static var alertTitle = R.string.localizable.allAccountsScreenAlertTitle()
        static var alertBody = R.string.localizable.allAccountsScreenAlertBody()

        static var addAccount = R.string.localizable.allAccountsScreenButtonAddAccount()
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = Constants.yourAccounts
    ...
    private lazy var addAccountButton: UIButton = {
        ...
        button.setTitle(Constants.addAccount, for: .normal)
   ...
   @objc private func didTapAddAccount() {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            let deleteAction = UIAlertAction(title: Constants.delete, style: .cancel) { [weak self] _ in
