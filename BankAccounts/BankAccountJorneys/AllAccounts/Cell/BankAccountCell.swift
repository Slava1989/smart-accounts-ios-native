...
final class BankAccountCell: UITableViewCell {
    struct Constants {
        static var disclaimerCurrency = R.string.localizable.allAccountsScreenDisclaimerCurrency("RON")
        static var noAvailableBalance = R.string.localizable.allAccountsScreenNoAvailableBalance()
    }
    ...
    private lazy var disclaimerLabel: UILabel = {
        ...
        label.text = Constants.disclaimerCurrency
    ...
    func configure(bankAccount: BankAccount) {
        ...
        if bankAccount.loadStatus == .error {
            ...
            disclaimerLabel.text = Constants.noAvailableBalance
        ...
        if bankAccount.currency.rawValue != "RON" {
            disclaimerLabel.isHidden = false
            disclaimerLabel.text = Constants.disclaimerCurrency
