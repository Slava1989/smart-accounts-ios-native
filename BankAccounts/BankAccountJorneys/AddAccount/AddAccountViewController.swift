...
final class AddAccountViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SetupViewDelegate {
    private struct Constants {
        static var disclaimer = R.string.localizable.addAccountScreenDisclaimer()
    }
    ...
    private lazy var disclaimerLabel: UILabel = {
        let label = UILabel()
        label.text = Constants.disclaimer
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            disclaimerLabel.topAnchor.constraint(equalTo: infoImageView.bottomAnchor),
