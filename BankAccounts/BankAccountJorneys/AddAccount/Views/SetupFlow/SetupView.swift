...
final class SetupView: UIView, TableOptionsDelegate {
    private struct Constants {
        static var selectPeriod = R.string.localizable.addAccountScreenSelectPeriod()
        static var selectAccount = R.string.localizable.addAccountScreenSelectAccount()
        static var selectCurrency = R.string.localizable.addAccountScreenSelectCurrency()
        static var sendRequest = R.string.localizable.addAccountScreenSendRequest()
    }
    ...
    private lazy var selectTitleLabel: UILabel = {
        ...
        label.text = Constants.selectPeriod
        label.isHidden = true
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
    ...
    private lazy var periodFormField: AddAccountFormField = {
        let formField = AddAccountFormField(frame: .zero, isExpandable: true, title: Constants.selectPeriod)
    ...
    private lazy var accountTitleField: AddAccountFormField = {
        let formField = AddAccountFormField(frame: .zero, isExpandable: false, title: Constants.selectAccount)
    ...
    private lazy var currencyFormField: AddAccountFormField = {
        let formField = AddAccountFormField(frame: .zero, isExpandable: true, title: Constants.selectCurrency)
    ...
    private lazy var sendButton: UIButton = {
        ...
        button.setTitle(Constants.sendRequest, for: .normal)
    ...
    private func showOrHideCurrencyTable(isShown: Bool) {
        ...
        selectTitleLabel.text = Constants.selectCurrency
    ...
    private func showOrHidePeriodTable(isShown: Bool) {
        ...
        periodFormField.isHidden = !isShown
        selectTitleLabel.isHidden = isShown
        selectTitleLabel.text = Constants.selectPeriod
