...
class CardCell: UICollectionViewCell {
    private struct Constants {
        static var name = R.string.localizable.allTransactionsScreenCardCellName()
        static var accountNumber = R.string.localizable.allTransactionsScreenCardCellAccountNumber()
        static var balance = R.string.localizable.allTransactionsScreenCardCellBalance()
    }
    ...
    private lazy var accountNumberHeaderLabel: UILabel = {
        let label = UILabel()
        label.textColor = .white
        label.text = Constants.accountNumber
        label.font = UIFont(name: "Helvetica", size: 13)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
